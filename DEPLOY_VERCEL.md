...
```bash
curl -L 'https://<deployment>/answers.data?author=&sortBy=newest&q=&minScore=1&fromDate=&toDate='
```

The response should include `minScore` and should not return unfiltered answer totals.
